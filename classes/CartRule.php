...
class CartRuleCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields'    => [
            ...
            'description'             => ['type' => self::TYPE_STRING, 'validate' => 'isCleanHtml', 'size' => self::SIZE_TEXT],
        ...
        'keys' => [
            'cart_rule' => [
                'group_restriction'   => ['type' => TableKey::KEY, 'columns' => ['group_restriction', 'active', 'date_to']],
                'group_restriction_2' => ['type' => TableKey::KEY, 'columns' => ['group_restriction', 'active', 'highlight', 'date_to']],
                'id_customer'         => ['type' => TableKey::KEY, 'columns' => ['id_customer', 'active', 'date_to']],
                'id_customer_2'       => ['type' => TableKey::KEY, 'columns' => ['id_customer', 'active', 'highlight', 'date_to']],
            ],
            'cart_rule_shop' => [
                'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_cart_rule', 'id_shop']],
            ],
        ],
    ];
