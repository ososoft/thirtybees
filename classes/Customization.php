...
class CustomizationCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'keys' => [
            'customization' => [
                'primary'              => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_customization', 'id_cart', 'id_product', 'id_address_delivery']],
                'id_cart_product'      => ['type' => TableKey::KEY, 'columns' => ['id_cart', 'id_product', 'id_product_attribute']],
